							...
							<ul class="ah-actions actions align-items-center">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu dropdown-menu-right">
										<li><i class="fa fa-user-circle"></i> عرض الكلف الشخصي</li>
										<li><i class="fa fa-users"></i>اضافة صديق</li>
										<li><i class="fa fa-plus"></i> اضافة الى مجموعة</li>
										<li><i class="fa fa-ban"></i> حظر</li>
									</ul>
								</li>
								<li>
