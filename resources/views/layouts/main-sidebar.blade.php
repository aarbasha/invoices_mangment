                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/Invoice_Paid') }}">الفواتير المدفوعة</a>
                            </li>
                        @endcan

                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/Invoice_UnPaid') }}">الفواتير الغير
                                    مدفوعة</a></li>
                        @endcan

                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('/Invoice_Partial') }}">الفواتير المدفوعة
                                    جزئيا</a></li>
                        @endcan

                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/Archive') }}">الفواتير المؤرشفة</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            ...
            @can('التقارير')
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/customers_report') }}">تقارير العملاء</a>
                            </li>
                        @endcan
                    </ul>
                </li>
