...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الأعدادات</h4>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    @can('اضافة قسم')
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            <a class="modal-effect btn btn-success btn-xl" data-effect="effect-scale" data-toggle="modal"
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">تم الانشاء من</th>
                                    ...
                                    <td>
                                        @can('تعديل قسم')
                                            <a class="modal-effect btn btn-sm btn-primary" data-effect="effect-scale"
                                                ...
                                                data-discription="{{ $x->discription }}" data-toggle="modal"
                                        ...
                                        @can('حذف قسم')
                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                data-id="{{ $x->id }}" data-section_name="{{ $x->section_name }}"
                                                data-toggle="modal" href="#modaldemo9" title="حذف"><i class="las la-trash"> حذف
                                                </i></a>
                                        @endcan
                                    </td>
                                </tr>
