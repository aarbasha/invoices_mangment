        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <div class="d-flex justify-content-between col-sm-6 col-md-3 mg-t-10">
                        @can('اضافة منتج')
                                        ...
                                        <td>
                                            @can('تعديل منتج')
                                             <button class="btn btn-primary btn-xl"
                                                data-name="{{ $y->Product_name }}" data-pro_id="{{ $y->id }}"
                                                data-section_name="{{ $y->section->section_name }}"
                                                data-discription="{{ $y->discription }}" data-toggle="modal"
                                                data-target="#edit_Product">تعديل</button>
                                            @endcan

                                            @can('حذف منتج')
                                            <button class="btn btn-danger btn-xl" data-pro_id="{{ $y->id }}"
                                                data-product_name="{{ $y->Product_name }}" data-toggle="modal"
                    ...
                    <form action='products/update' method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="discription" cols="20" rows="5" id='discription'
