            ...
            <div class=" main-content-body-invoice" id="print">
                <div class="card card-invoice">
                    <div class="card-body">
                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="tx-right">نسبة الضريبة ({{ $invoices->Value_VAT }})</td>
                        ...
                        <button class="btn btn-info  float-left mt-3 mr-2" id="print_Button" onclick="printDiv()">
                             <i class="mdi mdi-email ml-1"></i>ارسال بلبريد الالكتروني</button>

                        <button class="btn btn-dark  float-left mt-3 mr-2" id="print_Button" onclick="printDiv()">
                             <i class="mdi mdi-windows ml-1"></i>عرض</button>
