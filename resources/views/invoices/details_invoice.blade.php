                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form method="post" action="{{ url('/InvoiceAttachments') }}"
                                                        ...
                                                        <button type="submit" class="btn btn-outline-primary btn-lg"
                                                            name="uploadedFile">
                                                            <i class="fas fa-check-circle"></i>&nbsp; &nbsp;تاكيد</button>
                                                    </form>
                                                </div>
                                                @endcan
                                                <br>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('delete_file') }}" method="post">
                    ...
                    <div class="modal-body">
                        <p class="text-center">
                        <h4 style="color:rgb(255, 0, 0)"> هل انت متاكد من عملية حذف المرفق ؟</h4>
                        </p>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-info" data-dismiss="modal">الغاء</button>
                        <button type="submit" class="btn btn-outline-danger">تاكيد</button>
                    </div>
                </form>
            </div>
        </div>
